...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // NOTE: Static mock data removed. Chart is now driven by renderForecastChart()
  // which is called from forecast.js once real data is fetched.
  // The canvas #forecastChart still lives in forecast.html — nothing changes there.
...
// =========================================
// renderForecastChart — called by forecast.js with live data
// Kept outside DOMContentLoaded so forecast.js can call it freely.
// =========================================
...
function renderForecastChart({ historicalLabels, historicalAmounts, forecastLabels, forecastYhat, forecastUpper, forecastLower }) {
  ...
  // Destroy previous chart instance before re-rendering (handles Re-run button)
  ...
  // Historical line only covers the left portion; null-pad the right (forecast zone)
  const historicalData = [
    ...historicalAmounts,
    ...Array(forecastLabels.length).fill(null)
  ];

  // Forecast lines only cover the right portion; null-pad the left (historical zone)
